...
var Resizable = function (_React$Component) {
  ...
  Resizable.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        p = _objectWithoutProperties(_props, ['children', 'draggableOpts', 'width', 'height', 'handleSize', 'lockAspectRatio', 'axis', 'minConstraints', 'maxConstraints', 'onResize', 'onResizeStop', 'onResizeStart', 'handlerComponent']);

    var handler = handlerComponent || _react2.default.createElement('span', { className: 'react-resizable-handle' });
